...
const EventTable = process.env.GURUDWARA_EVENTS_DB;

const adminUpdateEventStatus: APIGatewayProxyHandler = async (event: APIGatewayEvent) => {
  try {
...
export const main = middyfy(adminUpdateEventStatus).use(checkAdminRole());
